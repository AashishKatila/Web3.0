    ...
    return (
        <div className='flex flex-col md:flex-row w-full justify-center items-center gradient-bg-services'>
            <div className="flex mf:flex-row flex-col justify-between md:p-20 py-12 px-4 ">
                <div className="flex-1 flex felx-col justify-start items-start ">
            ...
            <div className="flex-1 flex flex-col justify-start items-center ">
                <ServiceCard 
                    ...
                    subtitle = "Security is guaranted.We always maintain privacy and maintain quality of our products." 
                />
                <ServiceCard 
                    color = "bg-[#8945F8]" 
